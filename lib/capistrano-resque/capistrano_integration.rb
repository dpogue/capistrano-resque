        ...
        namespace :resque do
            ...
            for_each_workers do |role, workers|
              ...
              workers.each_pair do |queue, number_of_workers|
                ...
                number_of_workers.times do
                  ...
                  run("cd #{current_path}/rails && rvm use #{rvm_ruby_string} && RAILS_ENV=#{rails_env} QUEUE=\"#{queue}\" \
          ...
          namespace :scheduler do
            ...
            task :start, :roles => :resque_scheduler do
              run "cd #{current_path}/rails && rvm use #{rvm_ruby_string} && RAILS_ENV=#{rails_env} \
